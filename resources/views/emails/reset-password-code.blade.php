...
<head>
    ...
    <title>Kode Reset Password - BACT 2027</title>
</head>
                    ...
                    <tr>
                        <td style="padding:32px;">
                            <div style="font-size:15px;line-height:1.7;color:#374151;">
                                ...
                                <p>Kode berlaku selama <strong>{{ $expiresInMinutes }} menit</strong>. Jika Anda tidak meminta reset password, abaikan email ini.</p>
                            </div>
                        </td>
                    </tr>
                    <tr>
