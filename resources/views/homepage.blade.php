...
<body class="antialiased font-sans bg-[#FFFFFF] text-gray-800">
    ...
    <!-- =========================================================
         ...
         ========================================================= -->
    <nav class="fixed top-0 w-full z-50 px-6 py-4 bg-[#FFFFFF]/95 backdrop-blur-md shadow-sm border-b border-gray-100">
        <div class="max-w-7xl mx-auto flex justify-between items-center">
            ...
            <div class="hidden md:flex space-x-6 text-[13px] lg:text-sm font-semibold">
                <a href="/#beranda"
                    class="nav-scroll hover:text-[#E19404] transition {{ request()->is('/') ? 'text-[#E19404]' : 'text-gray-700' }}">Beranda</a>
                ...
                <a href="/program-ilmiah"
                    class="hover:text-[#E19404] transition {{ request()->is('program-ilmiah*') ? 'text-[#E19404]' : 'text-gray-700' }}">Program
                    Ilmiah</a>
                <a href="{{ route('booking.index') }}"
                    class="hover:text-[#E19404] transition {{ request()->routeIs('booking.*') || request()->is('booking*') || request()->is('checkout*') ? 'text-[#E19404]' : 'text-gray-700' }}">Pesan
                    Tiket</a>
                <a href="/hotel"
    ...
    <footer class="bg-white py-12 border-t border-gray-100">
        <div class="max-w-7xl mx-auto px-6 flex flex-col sm:flex-row items-center justify-between gap-6">
            ...
            <div class="flex items-center gap-6 text-xs font-bold text-gray-600">
                <a href="https://instagram.com" target="_blank" class="hover:text-[#E19404] transition">Instagram</a>
                <a href="https://youtube.com" target="_blank" class="hover:text-[#E19404] transition">YouTube</a>
                <a href="https://whatsapp.com" target="_blank" class="hover:text-[#E19404] transition">WhatsApp</a>
            </div>

            <p class="text-xs text-gray-400 font-medium">
                &copy; {{ date('Y') }} BACT Event System. All rights reserved.
            </p>
        </div>
    </footer>
