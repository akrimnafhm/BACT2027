...
<body class="antialiased font-sans bg-[#F4F5F7] text-gray-800 min-h-screen flex flex-col">
    ...
    <main class="max-w-7xl mx-auto px-6 pt-32 pb-16 flex-grow w-full space-y-10">
        ...
        <div class="text-center max-w-3xl mx-auto space-y-3">
            ...
            <h1 class="text-3xl md:text-4xl font-black text-[#234661]">Pilihan Kamar Hotel De Djokja BACT 2027</h1>
            <p class="text-sm md:text-base text-gray-600 leading-relaxed">
                Nikmati kenyamanan menginap di venue utama simposium dengan harga khusus peserta. Pilih tipe kamar yang sesuai dengan preferensi Anda.
            </p>
        </div>
        ...
        <!-- Tautan kembali ke daftar reservasi (khusus peserta yang sudah login lengkap) -->
        @if(isset($status) && $status === 'ready')
            <div class="max-w-5xl mx-auto flex justify-start">
                <a href="{{ route('hotels.index') }}" class="inline-flex items-center gap-1.5 text-sm font-bold text-[#234661] hover:text-[#E19404] transition">
                        ...
                        <div class="p-7 flex flex-col flex-grow justify-between space-y-6">
                            <div class="space-y-4">
                                ...
                                <p class="text-sm text-gray-600 leading-relaxed">
                                    {{ $hotel->description ?: 'Kamar bernuansa nyaman dan elegan untuk mendukung kelancaran aktivitas Anda selama simposium berlangsung.' }}
                                </p>
    ...
    <!-- 4. LIGHTBOX & PENGGERAK SLIDER FOTO -->
