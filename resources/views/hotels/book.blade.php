...
<body class="antialiased font-sans bg-[#F4F5F7] text-gray-800 min-h-screen flex flex-col">
    ...
    <!-- 1. NAVBAR -->
    <nav class="fixed top-0 w-full z-50 px-6 py-4 bg-white shadow-sm border-b border-gray-100">
            ...
            <div class="flex items-center space-x-4">
                @auth
                    <div class="relative group cursor-pointer">
                        <div class="flex items-center space-x-2 text-gray-700 hover:text-[#E19404] transition font-bold text-sm">
                ...
                <form action="{{ route('hotels.store', $hotel->id) }}" method="POST" class="space-y-8 m-0">
                    ...
                    <div>
                        <button type="submit" 
                                id="submit_btn" 
                                disabled
                                onclick="window.location='{{ $paymentUrl }}'"
