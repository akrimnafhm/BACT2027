...
<body class="bg-[#F4F5F7] min-h-screen flex flex-col font-sans">
    ...
    <main class="max-w-full mx-auto px-12 py-10 flex-grow w-full space-y-6">
        ...
        {{-- ================================================================
             [DINONAKTIFKAN] PANEL SCREENING ANGGOTA GRUP WHATSAPP (CSV)
             Fitur dinonaktifkan karena klien tidak jadi menggunakannya.
             Kode sengaja dipertahankan — untuk mengaktifkan kembali,
             cukup hapus pembungkus komentar Blade di bawah ini.
        ================================================================ --}}
        {{--
        @if($tab === 'peserta')
                            ...
                            <tr class="hover:bg-gray-50/80 transition">
                                ...
                                <td class="py-3.5 px-5">
                                    <div class="flex items-center gap-1.5">
                                        ...
                                        {{-- [DINONAKTIFKAN] Badge sudah-join grup WhatsApp (fitur screening WA nonaktif)
                                ...
                                <td class="py-3.5 px-5 text-center whitespace-nowrap">
                                    ...
                                    @else
                                        ...
                                        <div class="flex items-center justify-center gap-1.5">
                                            ...
                                            @else
                                                {{-- [DINONAKTIFKAN] Konfirmasi/tandai join grup WhatsApp (fitur screening WA nonaktif)
                                                @if($item->user)
