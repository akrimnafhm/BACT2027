                    ...
                    @foreach($paidBookings as $booking)
                        <div class="flex flex-col md:flex-row gap-6 items-center bg-gray-50 p-6 rounded-xl border border-dashed border-gray-300">
                            ...
                            <div class="flex-1 text-center md:text-left">
                                ...
                                <div class="mt-4 flex flex-wrap items-center justify-center md:justify-start gap-2">
                                    @if(!empty($booking->wa_group_url))
                                        <a href="{{ $booking->wa_group_url }}" target="_blank" rel="noopener" class="inline-flex items-center gap-1.5 bg-green-600 hover:bg-green-700 text-white text-xs font-bold py-2 px-4 rounded-lg transition shadow-sm">
                                            ...
                                            Join Grup {{ $booking->wa_group_label }}
                                        </a>
                                    @endif
                                    <a href="{{ route('invoice.ticket.preview', $booking->id) }}" class="inline-flex items-center gap-1.5 bg-[#234661] hover:bg-[#1c3b54] text-white text-xs font-bold py-2 px-4 rounded-lg transition shadow-sm">
