                    ...
                    <div class="mt-6 mb-6 bg-white rounded-2xl shadow-sm p-6 border border-gray-200">
                        ...
                        <div class="flex flex-wrap gap-3">
                            @foreach($groupLinks as $category => $link)
                                <a href="{{ route('booking.wa-join', ['category' => $category]) }}" target="_blank" rel="noopener" class="inline-flex items-center gap-2 bg-green-600 hover:bg-green-700 text-white text-sm font-bold py-2.5 px-5 rounded-xl transition shadow-md">
