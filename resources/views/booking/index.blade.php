...
<head>
    ...
    <title>Event Details - BACT 2027</title>
        ...
        <div class="space-y-8">
            ...
            @elseif($status === 'incomplete')
                <div class="bg-yellow-50 rounded-2xl shadow-sm p-8 border border-yellow-200 text-center">
                    ...
                    <p class="text-yellow-700 mb-6 text-sm">Mohon lengkapi NIK dan verifikasi email Anda terlebih dahulu pada halaman profil.</p>
