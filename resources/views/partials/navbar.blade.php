...
<nav class="fixed top-0 w-full z-50 px-6 py-4 {{ $navbarBg }} border-b border-gray-100">
    ...
    <div id="navbarMobileDrawer"
        class="fixed top-0 right-0 h-full w-72 max-w-[85vw] bg-white shadow-2xl z-50 transform translate-x-full transition-transform duration-300 flex flex-col md:hidden">
